...
class ApprovalFetchInstance(InstanceResource):
    ...
    :ivar  Contains the whatsapp approval information for the Content resource, with fields such as approval status, rejection reason, and category, amongst others.
    ...
    def __init__(self, version: Version, payload: Dict[str, Any], sid: str):
        ...
        self. Optional[Dict[str, object]] = payload.get("whatsapp")
